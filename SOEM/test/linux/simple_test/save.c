...
// #include <stdio.h>
// // #include "rtwtypes.h"
// // #include "timer_interrupt_program.h"
// // #include "mVeh.h"
// #include "sendUdp.h"
...
// uint8_t data5[16];
// uint8_t data6[16];
// uint8_t data7[16] = {0, 0x80, 0, 0, 0, 0, 0, 0};
...
// boolean init_setting(char *ifname);
...
// void interactWith_etherCAT(char *ifname)
// {
...
// void deal_data()
// {
//     uint16 number_of_runs = 0;
//     while (number_of_runs < 1100 * 36)
//     {
//         number_of_runs++;
//         osal_usleep((int)waitTime);
//         // 发送PDO数据
...
//         boolean flag[10] = {0};
//         data7[7] = 0x0F & (number_of_runs % 0x0F);
//         uint8_t test1 = number_of_runs & 0xFF;
//         data1[1] = test1;
//         flag[0] = write_Into_pos(2, 0x5B, data1);
//         flag[1] = write_Into_pos(2, 0x2C3, data2);
//         flag[2] = read_from_pos(2, 0x70, data3);
//         flag[3] = read_from_pos(2, 0x71, data4);
//         flag[4] = read_from_pos(2, 0x80, data5);
//         flag[5] = read_from_pos(3, 0x4B, data6);
//         flag[6] = write_Into_pos(4, 0x151, data7);
...
//             printf("%.2x ", data6[i]);
//          printf("\n");
//         // if (data6[2] & 0x80 == 0x80)
//         //     data1[2] = data1[3] = 0;
//         if (number_of_runs > 400 * 36)
//             write_Into_pos(4, 0x151, data7);
//         ec_send_processdata();
...
//         sendUdpMsg(float_data_toBe_display, sizeof(float_data_toBe_display) / sizeof(float), &udp_struct_float);
//         sendUdpMsg(uint8_data_toBe_display, sizeof(uint8_data_toBe_display), &udp_struct_uint8);
//     }
// }
...
//         {
//             // printf("Processdata cycle %4d. WKC %d  \n ", i, wkc);
//             memcpy(mVeh_DW.HWcan1_uDout_msg1_DSTATE, data1, sizeof(mVeh_DW.HWcan1_uDout_msg1_DSTATE));
//             memcpy(mVeh_DW.HWcan1_uDout_msg2_DSTATE, data2, sizeof(mVeh_DW.HWcan1_uDout_msg2_DSTATE));
//             memcpy(mVeh_DW.HWcan3_uDout_msg1_DSTATE, data7, sizeof(mVeh_DW.HWcan1_uDout_msg1_DSTATE));
